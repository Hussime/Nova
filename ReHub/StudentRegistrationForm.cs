...
namespace ReHub
{
    public partial class StudentRegistrationForm : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Заполните обязательные поля: ФИО, Группа, Логин, Пароль", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            try
            {
                using (var connection = DatabaseHelper.GetConnection())
                {
                    ...
                    MessageBox.Show($"Студент {txtFullName.Text} успешно зарегистрирован!", "Успех", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                MessageBox.Show($"Ошибка регистрации студента: {ex.Message}", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
